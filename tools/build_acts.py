...
COMBAT_META = {
    ...
    "狮子混种": ("城墙垛口", "狮子混种在垛口徘徊，巨爪刮过石砖的声音令人牙酸。"),
}
...
ELITE_META = {
    ...
    "大树守卫": ("宁姆格福大道", "大树守卫横在路口，巨盾投下的阴影比雾还冷。"),
    "坠星兽": ("结晶坑道", "坠星兽在坑道深处刨动星尘，每一次落地都让辉石碎屑飞溅。"),
}
...
ACTS = [
    {
        ...
        "elite": _elite_list(["法姆亚兹拉的兽人", "亚人首领", "挖石山妖", "大树守卫"]),
        "reward_cards": [
            "great_knife",
            "bloodhounds_step",
            "assassins_approach",
    ...
    },
    {
        ...
        "combat": _combat_list(["葛瑞克骑士", "腐败眷属", "挖石山妖", "凯丹佣兵", "狮子混种"]),
    ...
    },
    {
        ...
        "elite": _elite_list(["熔炉骑士", "守墓斗士", "挖石山妖", "坠星兽"]),
        "reward_cards": [
            "glintstone_arc",
            "volcano_pot",
            "catch_flame",
