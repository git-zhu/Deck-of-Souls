...
> 日期：2026-05-23
> 目标：让《Deck of Souls》整体美术风格贴近艾尔登法环（暗黑奇幻、暗金、石碑、雾、符文），
> 并为 PC 与手机端操作做人性化便捷优化。
>
> **执行状态（2026-05-23）：已落地** — 自产 SVG 背景/图标/分隔线、屏幕转场动画、
> 悬停反馈、战斗飘字、镀金框、PC 快捷键与滚轮、触屏滑动、输入动作与焦点导航。
> 全量 28 项 headless 测试通过（新增 `input_test`）。
